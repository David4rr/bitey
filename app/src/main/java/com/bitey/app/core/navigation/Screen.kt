...
sealed class Screen(
    ...
    data object Journal : Screen("journal", "Journal", icon = Icons.AutoMirrored.Rounded.MenuBook)
    data object Footprints : Screen("footprints", "Footprints", icon = Icons.Rounded.Place) {
    ...
    data object NewEntry : Screen("new_entry", "Capture", icon = Icons.Rounded.CameraAlt)
    data object FateTable : Screen("fate_table", "Fate's Table", icon = Icons.Rounded.AutoAwesome)
    data object Scrapbook : Screen("scrapbook", "Scrapbook", icon = Icons.Rounded.Collections)
    data object Profile : Screen("profile", "Profile", icon = Icons.Rounded.Person)
